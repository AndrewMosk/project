...
SELECT * FROM ora_replog999 WHERE ora_replog999."N_TABLE" = 'S_APERIOD' AND ora_replog999."OPER" = 'S';
...
FROM ora_s_aperiod WHERE ora_s_aperiod.r_p IN (SELECT ora_replog_temp."R_TABLE"::numeric FROM ora_replog_temp)
