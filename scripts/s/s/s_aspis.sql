...
SELECT * FROM ora_replog999 WHERE ora_replog999."N_TABLE" = 'S_ASPIS' AND ora_replog999."OPER" = 'S';
...
SELECT "sp_cod", "sp_form", "cz_cod", "k_priz", "nun_cod", "sumv", "kolv", "fil_cod", "otd_cod", "pbo_bank", "godr", "mesr", "r_p", "period", "pp_cod", 
		"pp_date", "p_modi", "d_modi"
FROM ora_s_aspis WHERE ora_s_aspis.sp_cod IN (SELECT ora_replog_temp."R_TABLE"::numeric FROM ora_replog_temp)
