...
SELECT * FROM ora_replog999 WHERE ora_replog999."N_TABLE" = 'S_APERIODM' AND ora_replog999."OPER" = 'S';
...
FROM ora_s_aperiodm WHERE ora_s_aperiodm.r IN (SELECT ora_replog_temp."R_TABLE"::numeric FROM ora_replog_temp)
