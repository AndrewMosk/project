...
SELECT * FROM ora_replog999 WHERE ora_replog999."N_TABLE" = 'S_ADEP' AND ora_replog999."OPER" = 'S';
...
SELECT "r", "reg_num", "sp_num", "godrd", "mesrd", "r_pd", "periodd", "spd_cod", "spd_date", "cz_cod", "godr", "mesr", "r_p", "period", "nun_cod", "sumd", 
		"sp_cod", "pp_date", "p_modi", "d_modi"
FROM ora_s_adep WHERE ora_s_adep.r IN (SELECT ora_replog_temp."R_TABLE"::numeric FROM ora_replog_temp)
