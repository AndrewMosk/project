...
SELECT * FROM ora_replog999 WHERE ora_replog999."N_TABLE" = 'S_PERIODM' AND ora_replog999."OPER" = 'S';
...
FROM ora_s_periodm WHERE ora_s_periodm.r IN (SELECT ora_replog_temp."R_TABLE"::numeric FROM ora_replog_temp)
