...
SELECT * FROM ora_replog999 WHERE ora_replog999."N_TABLE" = 'S_SPISD' AND ora_replog999."OPER" = 'S';
...
FROM ora_s_spisd WHERE ora_s_spisd.sp_cod IN (SELECT ora_replog_temp."R_TABLE"::numeric FROM ora_replog_temp)
