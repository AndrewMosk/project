...
public class Utils {
    ...
    public static String[][] getTables() {
        return new  String[][]  {
                {"cl", "*CL", "CL_ADDRESS", "CL_BANK", "CL_CONTACT", "CL_OKVED", "CL_P", "CL_POTR", "CL_POTRV", "CL_PSPIS", "CL_MV", "CL_MVNP", "CL_MVPERS", "CL_MVRAB",
...
//                {"pers", "*PERS", "PERS_BOLN", "PERS_BOOK", "PERS_DEF", "PERS_LANG", "PERS_OR", "PERS_PCL", "PERS_POOR", "PERS_PROF", "PERS_PROFIL", "PERS_REZ", "PERS_SIELEV", "PERS_SPEC",
//                        "PERS_SPEN", "PERS_STAJ"},
//
//                {"vac", "*VAC", "VAC_AGR", "VAC_CNT", "VAC_CR", "VAC_DEF", "VAC_DISTR", "VAC_FAIR", "VAC_FAIR_CL", "VAC_FAIR_DEF", "VAC_FAIR_PERS", "VAC_FAIR_PROF", "VAC_FREE_PACK", "VAC_FREE_VAC",
